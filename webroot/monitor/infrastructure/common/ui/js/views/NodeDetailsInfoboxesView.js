...
define([
    ...
    var NodeDetailsInfoboxesView = ContrailView.extend({
        initialize: function(options) {
            ...
            var nodeDetailInfoboxesTemplate = contrail.getTemplate4Id(cowc.TMPL_NODE_DETAIL_INFOBOXES_BOX);
        ...
        add: function(cfg) {
            ...
            //Intiialize the Sparklines
//            var sparkLineView1 = new SparklineView({
//                model:cfg['model'],
//                el:self.$el.find('.infobox-content .infobox-sparkline1')
//            });
//            var sparkLineView2 = new SparklineView({
//                model:cfg['model'],
//                el:self.$el.find('.infobox-content .infobox-sparkline2')
//            });
//            sparkLineView1.render();
//            sparkLineView2.render();
//            
            self.renderView4Config(self.$el.find('#'+ prefix + '-sparklines').find('.infobox-content .sparkline1'), cfg['model'],
                    getNodeDetailSparklineViewConfig1(cfg));
            self.renderView4Config(self.$el.find('#'+ prefix + '-sparklines').find('.infobox-content .sparkline2'), cfg['model'],
...
//                updateCnt();
    ...
    function getNodeDetailSparklineViewConfig1(cfg) {
        return {
            ...
            view: "SparklineView",
            viewConfig: {
                colorClass : contrail.checkIfExist(cfg.sparline1ColorClass) ? cfg.sparline1ColorClass : 'blue-sparkline',
    ...
    function getNodeDetailSparklineViewConfig2(cfg) {
        return {
            ...
            view: "SparklineView",
            viewConfig: {
                colorClass : contrail.checkIfExist(cfg.sparline2ColorClass) ? cfg.sparline2ColorClass : 'green-sparkline',
    //            modelConfig: getNodeCPUMemModelConfig(hostname, endTime),
                parseFn: function (response) {
