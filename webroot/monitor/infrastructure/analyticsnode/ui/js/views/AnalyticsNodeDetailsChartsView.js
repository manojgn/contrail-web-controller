...
define([
    ...
    function getInfoboxesConfig(config) {
        var analyticsNodeDetailsCollectorChartListModel = new AnalyticsNodeDetailsCollectorChartListModel(config);
        var analyticsNodeDetailsQEChartListModel = new AnalyticsNodeDetailsQEChartListModel(config);
        var analyticsNodeDetailsAnalyticsChartListModel = new AnalyticsNodeDetailsAnalyticsChartListModel(config);
        return [{
            title: 'Collector',
